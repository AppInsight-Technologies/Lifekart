...
Future<void> main() async {
  ...
  if(!PrefUtils.prefs!.containsKey("branch"))
    PrefUtils.prefs!.setString("branch", "67");
            ...
            builder: (BuildContext context, store, VxStatus? status) {
              return  MaterialApp.router(
                ...
                theme: ThemeData(
                  ...
                  pageTransitionsTheme: NoTransitionsOnWeb(), colorScheme: ColorScheme.fromSwatch(primarySwatch: MaterialColor(0xff39827E, {
                    50: Color(0xff282829),
                    100: Color(0xff282829),
                    200: Color(0xff282829),
                    300: Color(0xff282829),
                    400: Color(0xff282829),
                    500: Color(0xff282829),
                    600: Color(0xff282829),
                    700: Color(0xff282829),
                    800: Color(0xff282829),
                    900: Color(0xff282829),
                  })).copyWith(secondary: MaterialColor(0xff282829, {
                    50: Color(0xff282829),
                    100: Color(0xff282829),
                    200: Color(0xff282829),
                    300: Color(0xff282829),
